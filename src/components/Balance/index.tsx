        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8' >
            <div className='col-span-2 p-6 shadow-sm'>
                <div className='flex items-center gap-16 lg:gap-32'>
                    <div>
                        <p className='text-base_gray font-medium text-sm lg:text-base'>Available Balance</p>
                        <h3 className='text_primary text-2xl lg:text-4xl font-bold mt-2'>USD {isLoading ? '0.00' : data?.balance} </h3>
                    </div>
                    <button className='bg-primary px-6 lg:px-12 py-4 rounded-full text-base_white font-semibold hover:opacity-50'>Withdraw</button>
                </div>
                <div className='mt-8'>
                    {loading ?
